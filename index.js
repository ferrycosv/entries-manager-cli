...
const entriesManager = (entries, command, key, value) => {
  ...
  //  alert the user and exit early if it is not
  const options = ["all","read","write","delete"];
  ...
  const writeFileCallback = (err) => {
    ...
    if (err) { console.log("Could not save the changes, please try again...") } else {
...
const readFileCb = (err, entriesString) => {
  ...
  if (err) { console.log("Error while reading file...") } else {
